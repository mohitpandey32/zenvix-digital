    ...
    <>
      <section className="banner">
            ...
            <div className="col-12">
              <div className="banner__content">
                <h1 className="text-uppercase text-start fw-9 mb-0 title-anim">
                  We are
                  &nbsp; <span className="text-stroke">Zenvix</span>
                ...
                <div className="banner__content-inner">
                  <p>
                    We design and develop fast, modern, and SEO-optimized
                    websites that turn visitors into customers and help
                  ...
                  <div className="cta section__content-cta">
                    ...
                    <div className="single">
                      ...
                      <p className="fw-5">websites delivered</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="banner-left-text banner-social-text d-none d-md-flex">
          <Link href="mailto:hello@zenvixdigital.in">mail : hello@zenvixdigital.in</Link>
          <Link href="https://zenvixdigital.in">www.zenvixdigital.in</Link>
        </div>
