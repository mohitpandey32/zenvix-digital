...
import digitalStrategy from "public/images/agency/digital-strategy.png";
import marketingAnalytics from "public/images/agency/marketing-analytics.png";
          ...
          <div className="col-12 col-lg-6">
            <div className="agency__content section__content">
              <span className="sub-title">
                WELCOME TO ZENVIX DIGITAL
                <i className="fa-solid fa-arrow-right"></i>
              </span>
              <h2 className="title title-anim">
                Your Growth-Focused Web Development Partner
              </h2>

              <div className="paragraph">
                <p>
                  At Zenvix Digital, we build modern, high-converting websites
                  that help startups, small businesses, coaches, and personal
                  brands grow online. Every website we deliver is fast,
                  SEO-ready, and designed to generate real leads and sales.
                </p>
              </div>
              <div className="skill-wrap">
                ...
                <div className="skill-bar-single">
                  <div className="skill-bar-title">
                    <p className="primary-text">SEO-Ready Structure</p>
                  </div>
                ...
                <div className="skill-bar-single">
                  <div className="skill-bar-title">
                    <p className="primary-text">Performance Optimization</p>
                  </div>
