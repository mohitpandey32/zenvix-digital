                      ...
                      <div className="col-12 col-lg-7 offset-lg-1 col-xxl-7 offset-xxl-1">
                        <div className="testimonial-s__content">
                          ...
                          <div className="content">
                            <h4>
                              Zenvix Digital built our startup website in just 2 weeks.
                              It&apos;s fast, modern, and has already started generating
                              inbound enquiries. Their attention to detail and
                              clean design is exactly what we were looking for.
                            </h4>
                          </div>
                          <div className="content-cta">
                            <h5>Arjun Mehta</h5>
                            <p>Founder, LaunchPad Startup</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row gaper align-items-center">
                      ...
                      <div className="col-12 col-lg-7 offset-lg-1 col-xxl-7 offset-xxl-1">
                        <div className="testimonial-s__content">
                          ...
                          <div className="content">
                            <h4>
                              My coaching website now looks premium and professional.
                              Zenvix Digital delivered it on time, it loads incredibly fast,
                              and my clients constantly comment on how great it looks.
                              Best investment I&apos;ve made for my personal brand.
                            </h4>
                          </div>
                          <div className="content-cta">
                            <h5>Priya Sharma</h5>
                            <p>Business Coach &amp; Consultant</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row gaper align-items-center">
                      ...
                      <div className="col-12 col-lg-7 offset-lg-1 col-xxl-7 offset-xxl-1">
                        <div className="testimonial-s__content">
                          ...
                          <div className="content">
                            <h4>
                              We wanted to redesign our outdated business website and Zenvix Digital
                              exceeded every expectation. Our new site is sleek, blazing fast,
                              and Google PageSpeed scores went from 42 to 97.
                              Our online inquiries doubled within the first month.
                            </h4>
                          </div>
                          <div className="content-cta">
                            <h5>Rahul Verma</h5>
                            <p>Owner, Verma &amp; Associates</p>
                          </div>
                        </div>
                      </div>
                    </div>
